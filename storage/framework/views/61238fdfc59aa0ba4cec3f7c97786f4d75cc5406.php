        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-2 col-md-2 col-sm-12 col-12 text-center">
                    <img class="logo-medical " src="<?php echo e(asset('img/logo.png')); ?> " alt="Logo" >
                </div>
                    </div>
            
        </div>
    </div>
</footer><?php /**PATH /home/hdebian/Documentos/Repositorios/medicallife/resources/views/layouts/footers/homeFooter.blade.php ENDPATH**/ ?>