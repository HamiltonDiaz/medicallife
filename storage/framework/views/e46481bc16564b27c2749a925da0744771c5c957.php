    ...
    <div class="back-inicio" id="inicio">
        <div class="row" >            
            ...
            <div class="col-lg-5 col-md-5 col-sm-12 col-12 text-center" style="" >                
                <img class="logo-medical-inicio" src="<?php echo e(asset('img/logo.png')); ?> " alt="Logo">                
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hdebian/Documentos/Repositorios/medicallife/resources/views/welcome.blade.php ENDPATH**/ ?>