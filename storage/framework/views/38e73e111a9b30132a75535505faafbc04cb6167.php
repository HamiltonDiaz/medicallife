      ...
      <form class="form" method="POST" action="<?php echo e(route('register')); ?>">
        ...
        <div class="card card-login card-hidden mb-3">
          <div class="card-header card-header-primary text-center">
            <h4 class="card-title"><strong><?php echo e(__('Registro')); ?></strong></h4>
          ...
          <div class="card-body ">
            ...
            <div class="form-check mr-auto ml-3 mt-3">
              <label class="form-check-label">
                ...
                <?php echo e(__('Acepto la ')); ?> <a href="#"><?php echo e(__('Política de Privacidad')); ?></a>
              </label>
            </div>
          </div>
          <div class="card-footer text-center">
            <button type="submit" class="btn bg-login"><?php echo e(__('Crear Cuenta')); ?></button>
          </div>
        </div>
      </form>
    </div>
...
<?php echo $__env->make('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'register', 'title' => __('Material Dashboard')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GoogleDrive\Repositorios\medicallife\resources\views/auth/register.blade.php ENDPATH**/ ?>